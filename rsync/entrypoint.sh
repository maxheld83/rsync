...
rsync -r --delete-after --quiet -e "ssh -o StrictHostKeyChecking=no" _site/ pfs400wm@karli.rrze.uni-erlangen.de:/proj/websource/docs/FAU/fakultaet/phil/www.datascience.phil.fau.de/websource/ghaction-rsync
